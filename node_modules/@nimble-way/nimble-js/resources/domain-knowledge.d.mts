...
export declare class DomainKnowledge extends APIResource {
    /**
     * Resolves the suggested driver for a given URL or agent name. Exactly one of
     * `url` or `agent` must be provided.
     */
    getDriver(query?: DomainKnowledgeGetDriverParams | null | undefined, options?: RequestOptions): APIPromise<DomainKnowledgeGetDriverResponse>;
}
...
export declare namespace DomainKnowledge {
    export { type DomainKnowledgeGetDriverResponse as DomainKnowledgeGetDriverResponse, type DomainKnowledgeGetDriverParams as DomainKnowledgeGetDriverParams, };
}
//# sourceMappingURL=domain-knowledge.d.mts.map