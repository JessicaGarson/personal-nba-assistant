...
export declare class Crawl extends APIResource {
    /**
     * Crawl by Filter
     *
     * @example
     ...
     * ```
     */
    list(query?: CrawlListParams | null | undefined, options?: RequestOptions): APIPromise<CrawlListResponse>;
    /**
     * Create crawl task
     *
     * @example
...
export declare namespace CrawlListResponse {
    /**
     * Crawl API response
     */
    interface Data {
...
export declare namespace CrawlRunResponse {
    interface CrawlOptions {
        allow_external_links: boolean;
        allow_subdomains: boolean;
        crawl_entire_domain: boolean;
...
export declare namespace CrawlStatusResponse {
    interface CrawlOptions {
        allow_external_links: boolean;
        allow_subdomains: boolean;
        crawl_entire_domain: boolean;
...
export declare namespace CrawlRunParams {
    interface UnionMember0 {
        url: string;
        events?: Array<'started' | 'page' | 'completed' | 'failed'>;
        headers?: {
...
export declare namespace Crawl {
    export { type CrawlListResponse as CrawlListResponse, type CrawlRunResponse as CrawlRunResponse, type CrawlStatusResponse as CrawlStatusResponse, type CrawlTerminateResponse as CrawlTerminateResponse, type CrawlListParams as CrawlListParams, type CrawlRunParams as CrawlRunParams, };
}
//# sourceMappingURL=crawl.d.mts.map