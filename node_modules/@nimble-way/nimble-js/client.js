...
var _Nimble_instances, _a, _Nimble_encoder, _Nimble_baseURLOverridden;
...
const crawl_1 = require("./resources/crawl.js");
const domain_knowledge_1 = require("./resources/domain-knowledge.js");
const media_1 = require("./resources/media.js");
const serp_1 = require("./resources/serp.js");
...
class Nimble {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('NIMBLE_BASE_URL'), apiKey = (0, env_1.readEnv)('NIMBLE_API_KEY') ?? null, clientSource = (0, env_1.readEnv)('CLIENT_SOURCE') ?? 'sdk', ...opts } = {}) {
        _Nimble_instances.add(this);
        _Nimble_encoder.set(this, void 0);
        this.agent = new API.Agent(this);
        this.crawl = new API.Crawl(this);
        this.tasks = new API.Tasks(this);
        this.batches = new API.Batches(this);
        this.domainKnowledge = new API.DomainKnowledge(this);
        this.media = new API.Media(this);
        this.serp = new API.Serp(this);
        const options = {
            apiKey,
            clientSource,
            ...opts,
        ...
        this.timeout = options.timeout ?? _a.DEFAULT_TIMEOUT /* 3 minutes */;
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('NIMBLE_LOG'), "process.env['NIMBLE_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Nimble_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('NIMBLE_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Nimble_instances, "m", _Nimble_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Nimble_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Nimble = Nimble;
_a = Nimble, _Nimble_encoder = new WeakMap(), _Nimble_instances = new WeakSet(), _Nimble_baseURLOverridden = function _Nimble_baseURLOverridden() {
    return this.baseURL !== 'https://sdk.nimbleway.com';
};
Nimble.Nimble = _a;
Nimble.DEFAULT_TIMEOUT = 180000; // 3 minutes
Nimble.NimbleError = Errors.NimbleError;
Nimble.APIError = Errors.APIError;
Nimble.APIConnectionError = Errors.APIConnectionError;
Nimble.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Nimble.APIUserAbortError = Errors.APIUserAbortError;
Nimble.NotFoundError = Errors.NotFoundError;
Nimble.ConflictError = Errors.ConflictError;
Nimble.RateLimitError = Errors.RateLimitError;
Nimble.BadRequestError = Errors.BadRequestError;
Nimble.AuthenticationError = Errors.AuthenticationError;
Nimble.InternalServerError = Errors.InternalServerError;
Nimble.PermissionDeniedError = Errors.PermissionDeniedError;
Nimble.UnprocessableEntityError = Errors.UnprocessableEntityError;
Nimble.toFile = Uploads.toFile;
Nimble.Agent = agent_1.Agent;
Nimble.Crawl = crawl_1.Crawl;
Nimble.Tasks = tasks_1.Tasks;
Nimble.Batches = batches_1.Batches;
Nimble.DomainKnowledge = domain_knowledge_1.DomainKnowledge;
Nimble.Media = media_1.Media;
Nimble.Serp = serp_1.Serp;
